...
public class TeacherControllerServlet extends HttpServlet {
	...
	private void listTeachers(
		...
		List<Teacher> teachers = teacherDbUtil.getStudents();
		
		for (Teacher t:teachers) {
			System.out.println(t);
		}
		
		teachers.add(new Teacher(999, "FirstName","lastName", "email@gmail"));
		// add students to the request
		request.setAttribute("LISTA_PROFESORES", teachers);
